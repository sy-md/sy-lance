...
music_folder = "../../atna_music/sy-music"
...
class video_converter:
    ...
    def convert(self):
        for flds in os.listdir(self.music):
            for x in os.listdir(self.music + "/{}".format(flds)):
                print(x)
    ...
    def test():
        ...
        def convert():
            ...
            for x in os.listdir():
                if x.endswith(".mp4") or x.endswith(".m4a"):
